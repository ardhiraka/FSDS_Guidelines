...
5. *Objektif* dari project ini adalah **mendeteksi edge suatu gambar dan melakukan operasi perkalian matriks**. Sebagai petunjuk, berikut langkah-langkah untuk mengerjakan Graded Challenge 2 :
    ...
    2. Hitung gradient magnitude tiap pixel dengan rumus <img src="http://www.sciweavers.org/tex2img.php?eq=%24mag%3D%5Csqrt%7B%28%5Cfrac%7B%5Cpartial%20I%7D%7B%5Cpartial%20x%7D%29%5E2%20%2B%20%28%5Cfrac%7B%5Cpartial%20I%7D%7B%5Cpartial%20y%7D%29%5E2%7D%24&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=0" align="center" border="0" alt="$mag=\sqrt{(\frac{\partial I}{\partial x})^2 + (\frac{\partial I}{\partial y})^2}$" width="174" height="35" />
